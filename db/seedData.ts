...
export default async function seed() {
  ...
  if (existingCount.length === 0) {
    ...
    console.log("Added 3 sample survey responses");
    return "Added 3 sample survey responses";
  } else {
    console.log("Survey responses already exist, skipping seed");
    return "Survey responses already exist, skipping seed";
  }
}
